...
/**
* @see \App\Http\Controllers\front\TaskController::index
 * @see app/Http/Controllers/front/TaskController.php:15
 * @route '/tasks'
 */
...
/**
* @see \App\Http\Controllers\front\TaskController::create
 * @see app/Http/Controllers/front/TaskController.php:31
 * @route '/tasks/create'
 */
...
/**
* @see \App\Http\Controllers\front\TaskController::store
 * @see app/Http/Controllers/front/TaskController.php:46
 * @route '/tasks'
 */
...
/**
* @see \App\Http\Controllers\front\TaskController::show
 * @see app/Http/Controllers/front/TaskController.php:71
 * @route '/tasks/{task}'
 */
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\front\TaskController::edit
 * @see app/Http/Controllers/front/TaskController.php:86
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\front\TaskController::update
 * @see app/Http/Controllers/front/TaskController.php:102
 * @route '/tasks/{task}'
 */
...
/**
* @see \App\Http\Controllers\front\TaskController::destroy
 * @see app/Http/Controllers/front/TaskController.php:132
 * @route '/tasks/{task}'
 */
