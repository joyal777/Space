...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: props.task.task_name, href: show(props.task.id).url },
    { title: 'Edit', href: '#' },
];
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head :title="`Edit ${task.task_name}`" />
        ...
        <div class="p-6 max-w-4xl mx-auto">
            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg shadow-md p-6 space-y-6">
                ...
                <div>
                    ...
                    ></textarea>
                    <p v-if="form.errors.task_description" class="mt-1 text-sm text-red-600">{{ form.errors.task_description }}</p>
                </div>
