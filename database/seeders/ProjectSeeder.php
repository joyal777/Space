...
class ProjectSeeder extends Seeder
{
    public function run()
    {
        $projects = [
            ...
            [
                'project_name' => 'Favabble',
                'project_title' => 'AI Automation Tool',
                'project_code' => 'PROJ-KVDUP4CR',
                'project_description' => 'AI automation tool for automating tasks.',
                'project_status' => 'in_progress',
                'project_update' => 'Updated gmail automation',
                'start_date' => '2024-01-05',
                'end_date' => 'N/A',
            ],
        ];
